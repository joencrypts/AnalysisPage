...
const scenarios: ScenarioData[] = [
  {
    ...
    originalImage: '/old-area-building-broken-down-for-new-construction-in-shanghai-china-KTCFWJ.jpg',
    recreatedImage: '/182befd6-b011-486f-bb39-cc096cba9357.png',
  ...
  },
  {
    ...
    originalImage: '/IMG-20250411-WA0033.jpg',
    recreatedImage: '/68fd1bd6-80aa-4b2a-937e-d9802458509b.png',
  ...
  },
  {
    ...
    originalImage: '/1829697-road.jpg',
    recreatedImage: '/2367656d-3ec3-43cc-a0e6-a880b89fee4a.png',
  ...
  },
  {
    ...
    originalImage: '/576276591M-1741586970695.jpg',
    recreatedImage: '/f95ea189-7c38-4a2f-bccd-33ac2c602a7b.png',
  ...
  },
  {
    ...
    icon: <Building className="w-5 h-5" />,
    originalImage: '/earthquake-damage_0.jpg',
    recreatedImage: '/41fe7140-410d-48ea-94ad-87d92080159e.png',
        ...
        {selectedScenarios.length > 0 && (
          <div className="space-y-4 sm:space-y-6 md:space-y-8 mb-6 sm:mb-8">
            {getSelectedScenarioData().map((scenario, index) => (
              ...
              >
                <div className="bg-gradient-to-r from-emerald-400 to-emerald-500 px-4 sm:px-6 py-3 sm:py-4 transition-all duration-300 hover:from-emerald-500 hover:to-emerald-600">
